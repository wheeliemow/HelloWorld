...
void native_to_managed_trampoline_4 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	if (mono_domain_get () == NULL)
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "HelloWorld.AppDelegate, HelloWorld, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end
...
@implementation __NSObject_Disposer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "MonoTouch.Foundation.NSObject, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MonoTouch.Foundation.NSObject+NSObject_Disposer, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Drain");
	}
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "HelloWorld.AppDelegate, HelloWorld, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [2].handle = objc_getClass ("NSArray");
	__monotouch_class_map [3].handle = objc_getClass ("NSString");
	__monotouch_class_map [4].handle = objc_getClass ("NSAutoreleasePool");
	__monotouch_class_map [5].handle = objc_getClass ("UIResponder");
	__monotouch_class_map [6].handle = objc_getClass ("UIApplication");
	__monotouch_class_map [7].handle = objc_getClass ("UIScreen");
	__monotouch_class_map [8].handle = objc_getClass ("UIView");
	__monotouch_class_map [9].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [10].handle = objc_getClass ("NSException");
	__monotouch_class_map [11].handle = objc_getClass ("NSDictionary");
	__monotouch_class_map [12].handle = objc_getClass ("__NSObject_Disposer");
	monotouch_setup_classmap (__monotouch_class_map, 13);
}
